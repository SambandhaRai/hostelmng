...
class DormRoomStatusManagement(tk.Tk):
    def __init__(self):
        ...
        self.create_database()  # Call create_database method to ensure the database schema is created
    ...
    def create_widgets(self):
        ...
        save_btn.pack(side=tk.BOTTOM, pady=(10,0))  # Placed above the "Add Room" button
    ...
    def create_room_widgets(self, parent, room):
        ...
        cleanliness_var = tk.StringVar(value=room["Cleanliness"].get())  # Create a StringVar for OptionMenu
        ...
        room['cleanliness_var'] = cleanliness_var  # Store reference for later access
    ...
    def update_room(self, room, label, cleanliness_var, price_entry, update_button):
        ...
        self.update_table()
        self.update_database(room)
        update_button.config(state="normal")  # Set update_button state back to normal
